...
## Десятый день, Часть 2
    ...
    "Не все сразу удается вспомнить и записать в дневник. Например, историю про то, как мальчишки украли у нас одежду, когда мы купались ночью, и что было потом..."
