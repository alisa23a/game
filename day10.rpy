label day10:
    ...
    "Я представила Мэгги в драке и что-то мне поплохело. Точно трупики штабелем бы лежали. Нет, хорошо что они не видели."
    ...
    queue music "audio/music/love_epidemy.mp3"
    ...
    "Город пуст, одинокая птица
    \nЗабивает сухарь в тротуар
    \nА мы сверху смотрим на лица
    \nКогда-то веселых пар"

    "Ты молчишь, нынче тем нет
    \nДавит нас тишиной улиц
    \nСтранно, знаю тебя тысячу лет
    \nИ всё так же тобой любуюсь"

    "Я знаю, когда-нибудь двое беспечно
    \nСольются губами, сплетя тела 
    \nНаивно считая, что жизнь бесконечна 
    \nЧто данность прекрасна, а сущность светла"

    "Не зря же сказали Спаситель и Будда
    \nСпокойно, расслабьтесь, смотрите сюда 
    \nНичто не приходит у нас ниоткуда 
    \nИ не исчезает потом в никуда"

    "Подмело метлою сирен
    \nНиши вдруг опустевших дворов
    \nНу скажи мне, что мир не бренн
    \nИ земля нам в нём всем — кров"

    "И под звуки твоей правоты
    \nЯ открою, последнюю пачку
    \nВот, держи, может завтра — кранты
    \nУ меня ещё есть заначка..."
    ...
    "Я только два раза стукнула одного, прыщавого. Пнула ногой, как в карате, как меня Мэгги учила. Он сложился сразу."
    ...
    "Утренние занятие с Мэгги, пробежка и бокс с тенью, тоже как бы входят в физическую подготовку, но это все-таки не хореография."

    "И у Мэгги не кружок. Это мы её с Семёном упросили показать нам приёмчики. Она же морской пехотинец, хотя и скрывает это. Но нам, под большим секретом, про неё рассказала Саманта."
