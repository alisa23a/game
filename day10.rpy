...
## Десятый день, Часть 2
    ...
    pe "(Грозно) \nТы кто такой, малец, что бы старших перебивать?!"
    ...
    sl "Да вы не обращайте на него внимания, Архип Петрович,– Его тут уже давно никто не слушает кроме второго отряда. А что за батискаф на Рачьей отмели?"
