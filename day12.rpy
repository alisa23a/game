label day12:
    ...
    ul "Если починишь, я уговорю Женю, что бы ты покатал нас. Тем более, что грести толком никто из нас не умеет."
    ...
    "И мы разделились на зараженных и не зараженных. Ну, по желанию конечно. Зомбаками стали весь второй отряд и часть малышей. И также, кто-то из третьего отряда. У нас в зомбаки пошел Семен и кибернетики."
    ...
    "Они, например, не знали, что одно запасное черное знамя, Вампиры отдали Шурику (он был самый фанатичный вампиром и пользовался у них уважением) и он его обернул вокруг тела (так не нашли). А потом отнес нам и мы спрятали."
    ...
    "Потом, постепенно, всем надоело в это играть и их вампирское сообщество распалось. Нам было жалко вампиров, все-таки с ними было весело. Но им пришла амба. Как сказал Семен «Такова селява»."
