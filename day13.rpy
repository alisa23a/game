...
label day13_2:
    ...
    "Семён проиграл. Он заявил, что это была досадная случайность, и если бы была переигровка, то он бы выиграл. Тем не менее, но готов подчиниться правилам."
