...
label day13_2:
    ...
    ul "И в поселок за конфетами пусть переводчицу... эту, Мэгги пусть пошлет. Что она тут порожняком у нас проживается? Польза какая-никакая будет. Мой папа сказал бы «С худой овцы хоть шерсти клок»."
    ...
    "И вот, наконец, он согласился. Похоже, ему и самому хотелось. Просто вместе веселее."
    ...
    "Это был жесткий спор, спор на принцип. Никто не знал возможной реакции Мэгги и физрука на столь неожиданное действие со стороны пионеров."
    ...
    "Семён проиграл. Он заявил, что это была досадная случайность, и если бы была переигровка, то он бы выиграл. Тем не менее, он готов подчиниться правилам."
    ...
    al "Случайность? Тогда я дам тебе реванш. Так тебя устроит?"
    ...
    je "(Став между ними) \nЧто за торги? Переигровка не предусмотрена правилами."

    je "Впрочем, если отряд не против, я предложу такой компромисс."

    je "Если снова победит Алиса то проигрыш засчитывается Семёну, если выиграет Семён, это ничья. А ничья, это по правилам, проигрыш обоим."
    ...
    al "(Усмехнувшись) \nДа, вы получите два шоу, умно придумала Женечка. Допустим. Но тогда ему, нет смысла играть."
    ...
    sem "Нет есть. Утонув, я утащу тебя за собой. Моральное удовлетворение. Слышала о таком?"
    ...
    al "Да, очень «благородно». Ты жалок. Сдавай. \n(решительно садится играть)"
    ...
    "В этот раз Семён выиграл у Алисы. Публика восприняла такой исход с восторгом. Ведь «ничья», как назвала это Женя, сулила всем двойное удовольствие."
