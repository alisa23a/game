...
label day13_2:
    ...
    "В одной из игр выпало целоваться Семену и Шурику и те потребовали заменить условие. После споров, в наказание за отказ, обоих заставили 30 раз отжаться на скорость."
    ...
    "Но отвертеться не удалось. Народ жаждал зрелища здесь и сейчас. Алиса колебалась, но потом решительно притянула к себе Семена и..."
    ...
    "Лена стояла бледная, а у Слави выступила кровь на закушенной губе. Потом красный от смущения Семен учил всех играть в покер, а меня делать фокусы."
    ...
    "Затем сыграли в подкидного. Все постепенно выбыли и снова остались Алиса и Семен. И у каждого были свои болельщики. Проигравший должен был пойти ночью на Кладбище Горняков и остаться там до утра. Алиса проиграла."
