label day14:
    ...
    "А про Мику и Семена мне потом Толик рассказал (оказывается, у него тоже есть особенность, как у меня, все подмечать)."

    "Так вот, он рассказал, что периодически Семен с Мику брали гитару и на лодке уплывали (думаю на Остров Дальний). И возможно, там репетировали. (Ну да конечно,  репетировали, так я и поверила)."
    ...
    "Ну и Петрович нас прикрыл. ОД у него спросила: «Все в домиках? Никто не шлется по лагерю?» "
    ...
    "Подготовка продолжилась с утра и весь день. Только мы с Алисой в перерыве еще успели в библиотеку сходить, повернуть одно дело. Сейчас расскажу."
...
## Операция "Архив"
    ...
    "Ну вот. А один ящик был набит картами. Мы его быстро затолкали в угол, что бы потом выпотрошить. Потом зажегся свет. Женя быстро вернулась, мы папки сложили и закрыли подвал."
...
########################################
    ...
    "Потом Семен сказал Мику: «Поедем хоть на часик отвлечемся, а то голова уже совсем не работает»."
    ...
    "А тетя Люба ревнует, идет к Петровичу и говорит: «Налей мне песяшечку (50 грамм) своей Архиповки.» Ну и плачет, а тот ее утешает. Но ОД не смотрит на физрука. Кажется, она на Семена запала."


    scene cg boat_sem_od with dissolve

    "Это секрет. Но мне кажется, что этот «секрет» знает уже весь лагерь. Иначе как объяснить прогулку ОД на лодке с Семеном? Он сказал, что они осматривали остров, перед предстоящим походом туда нашего отряда."
    ...
    "Хотя Славя и Ленка тоже ревнуют, но на Ольгу Дмитриевну не обижаются, она всеобщая любимица. И потом, дело не в ней, а в Семене. Как говорит моя мама: «Наше дело бабское, ждать да надеяться»."
...
## Фотокружок
    ...
    "Но зато у нас есть Славя и ее фотокружок. Она может нас сфотографировать с гитарами и барабанами. А Семен написал бы объявление. Это была хорошая идея! И мы побежали в фотокружок, он как раз открылся после обеда."
    ...
    "Ну вот про Семена. Он сначала долго возился со светом. Направлял на нее разные лампы. И просил повернуться. То ему тени мешали, то она сидела недостаточно красиво."
    ...
    "Яблоко покатилось. Алиса нагнулась, взяла яблоко, потерла его и протянула Семену. Он как-то растерялся. А она ему, подделавшись под голос Слави: «Семочка, просто возьми яблочко»."
    ...
    "А Алиса ей: «Не учи ученую. Я знаю, как с фотоаппаратом обращаться. Могу не хуже Семена снимать»."

    hide sp_al_003
 
    "Тут я оглянулась, а Семена, как ветром сдуло. Сбежал."
    ...
    "Потом снимали наш ансамбль. Славе отдали пленку, а она обещала, что они с Семеном утром вывесят красивое объявление о концерте."
...
## Концерт
    ...
    "Ольга Дмитриевна покраснела как «маков цвет», бровки домиком, ломает руки  и все время спрашивает: «Что делать будем?» И почему-то у Семена. Вроде он как скорая неотложная помощь."
