label day14:
    ...
    scene cg blue_stocking with dissolve

    "Женя обедала прямо в библиотеке."
    ...
    queue music "audio/music/blue_stocking.mp3"


    "О чем ты мечтаешь, страницы листая 
    \nБиблиотечных книг и нот консерваторий
    \nСвое воображение мудростью питая 
    \nПрекрасных, но придуманных историй"

    "Каких героев на холстах рисуешь 
    \nКартин своей нетронутой души 
    \nКогда ты часто плачешь и ликуешь
    \nВ библиотечной находясь тиши"

    "Однажды я приду и взяв за руку нежно 
    \nВ мир настоящий уведу, на ухо прошептав
    \nМеня ты не ждала, я не герой конечно
    \nНо стал им, твои книги прочитав"

    "Спасал принцесс и убивал драконов 
    \nВсем жертвовал и умирал ради любви 
    \nСредневековых мрак я попирал законов 
    \nИ на кострах горел с тобой. Пойми."

    "Теперь мы неразлучны в настоящем 
    \nОставь пока на время книжное житьё
    \nЯ покажу тебе, как может быть изящно
    \nТвое воображенье и мое"

    "В моих глазах найдешь любую сказку 
    \nЯ Кот Баюн, я твой Калиф на час
    \nИ для историй, розовую краску 
    \nМы вместе их придумаем сейчас"
    ...
    "Я отведу тебя туда, где сны и грезы 
    \nВ Эдем вдруг превратив обычный сад 
    \nВ нем настоящие, живые розы 
    \nПрекрасный источают аромат"
    ...
    "Мы принесли ей печеньки. Ей дали задание протереть все полки и переложить на них книги. Отложить старые папки с верхних полок вниз и отнести эти папки в подвал."
    ...
    queue music "audio/music/snow_queen.mp3"
    ...
    "Мне говорили — не спеши \nВедь это бег за горизонт \nОна холодный лёд"

    "У льда, все знают, нет души \nОт снега не поможет зонт \nТебе не повезёт"

    "Она отвергла храбрецов \nЧей пыл не описать \nА уж таких как ты глупцов \nНа свете не сыскать"

    "Но всё же, если ты решил \nОпутать эту деву \nТо знай Никто не рассмешил \nСнежную Королеву"

    "Я верю, вдруг растает лёд \nОт близости сердец \nПусть это будет месяц, год \nНо это не конец"

    "Ты губ моих не отвергай \nИтог настойчивости нежной \nЯ растоплю твой лед как Кай \nВ чертогах Королевой Снежной"

    "Она сковала синевой \nСвоих холодных глаз \nВсе губы, что сказать хотят"

    "Как хорошо вдвоём с тобой \nПускай никто не верит в нас \nМне все равно, что говорят"

    "Я верю, вдруг растает лед \nОт близости сердец \nПусть это будет месяц, год \nНо это не конец"

    "Ты губ моих не отвергай \nИтог настойчивости нежной \nЯ растоплю твой лед как Кай \nВ чертогах Королевой Снежной"

    "Мы встретились под Новый Год \nЯ говорил, а она смеялась \nДа парень, а ты мягко стелешь" 

    "Зажала мне ладошкой рот \nЯ вижу зря я за тебя боялась \nИ тихо спросила: «А во что ты веришь?»"

    "Я верю, что растает лёд \nОт близости сердец \nПусть это будет месяц, год \nНо это не конец"

    "Ты губ моих не отвергай \nИтог настойчивости нежной \nЯ растоплю твой лед как Кай \nВ чертогах Королевой Снежной"

    "И в недоверчивых глазах \nВдруг появилось удивленье \nПроизнесла, смеясь в слезах \nЯ вижу принял ты решенье"

    "Да, ты вошел под звуки труб \nВ мой мир под шум метели снежной \nТы был находчив и негруб \nНу что ж, целуй, но только нежно"

    "Я верю если полюбить \nДаже холодную деву \nНе так уж трудно растопить \nСнежную Королеву"

    "Не надо казаться, надо быть \nИ верить в своё предназначенье \nРешив однажды, надо плыть \nПусть даже против теченья"
    ...
    "В общем, не все у нас шло по плану. И всему виной второй отряд. Они почему-то решили устроить забастовку. Есть у них там один баламут. Бывший помощник вожатого. Смутьянов его фамилия. Вот он и мутил там воду."
    ...
    pe "Есть баян у меня. С войны ещё остался."
    ...
    od "Хорошо, я попробую мобилизовать малышей из хора. Надеюсь, Хацунэ к Дню Памяти с ними репетировала военную тематику. Только уж вы своим скрипучим баритоном не портите впечатление. Сделаете затакт и дети начнут. Ладно?"
    ...
    "Петрович сходил в свою каптерку и принес баян. Сел на лавочку и ка-а-к запоет дурным голосом, частушки."
    ...
    "А ОД спрашивает: «Вы, Архип Петрович, сегодня принимали?»  А он обиделся. За кого, говорит, Ольга Дмитриевна, вы меня держите. Я на работе не пью. Хотел уйти совсем. Насилу отговорили. А баян у него, и правда, классный!"
