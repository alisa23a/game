label day16:
    ...
    scene inv_item_petrovich_map_full with dissolve 
    ...
    show got_petrovich_map
    with Dissolve(0.3)

    pause (1000000000000000000.0)

    hide got_petrovich_map
    ...
    "И вот карта… Тут я ее не буду прикладывать, подробную, потому что нельзя. Это секретная карта. Вдруг кто-нибудь украдет мой дневник."

    "А что бы было красиво, я нарисую кусочек карты. Без тех таинственных линий, что были на карте Петровича. Только наш маршрут."
    ...
    queue music "audio/music/painter.mp3"



    "Твой профиль был так безупречно строг
    \nМне ж, как назло, была нужна натура
    \nЯ протащилась за тобой, не чуя ног
    \nИ влипла как обычно. В общем, дура"

    "Позировать? Ну что же, если нужно
    \nС тобой, наверно, будет веселей
    \nНу а тебе со мной, наверно, скучно
    \nСмотри сама, потом, не пожалей"

    "И я пишу тебя на белых стенах
    \nВ моей палитре чёрный, белый, синий
    \nОни стучат в твоих прозрачных венах
    \nСтянув скелет как мел белесых линий"

    "Твой взгляд как бритва, только я не ною
    \nСквозь битое стекло судьбы, босую
    \nМеня зовет, я чувствую спиною
    \nСейчас, сейчас, вот только дорисую"

    "Пока ты жёг камин, я смешивала краски
    \nНалил бокал вина и вдруг, спросив
    \nКак ты увидела меня сквозь эту маску?
    \nТы был в тот миг божественно красив"

    "Цвет твоих глаз, зелёно-нежно-серый
    \nОтточен и продуман каждый жест
    \nТвой мир чужой, контрастный, чёрно-белый
    \nИ нес его ты, как Спаситель крест"
    ...
    "А сердце безнадежно бьется в клетке
    \nИ на себя уже нет смысла злиться
    \nНо вот загадка, что тебе в нимфетке
    \nКоторой угораздило влюбиться"

    "Таких как я, наивных пионерок
    \nТы видел сотнями на улицах столицы
    \nРисующих проспекты на пленэрах
    \nЧто за мольберты от смущенья прячут лица"
