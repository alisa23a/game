label day16:
    ...
    scene bg square_day with dissolve # Нужна картинка склада, а то одна и та же bg stock и bg watchmans_cabin_2
    ...
    scene black with dissolve # Нужен спрайт с Семёном в краске
