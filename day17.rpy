label day17:
    ...
    scene cg instruction2 with dissolve
    ...
    "Наконец, после того, как мы полчаса извивались в грязи, как два червяка, наши мученья увенчались успехом. И мы с Алисой выбралась, на тот самый «остров»."
