label day19:
    ...
    "Если мои предположения насчёт метро верны, то это должны быть или выходы или какие то технические шахты, ну, например, воздуховоды."
    ...
    ul "Остались Мику и Атсуи. К Саманте он подкатывать боится. Там Мэгги. Она его в бараний рог согнет. Видела, какие у неё мышцы? А пресс?"
    ...
    "Я спросила её, выполнил ли Семён свою часть уговора, условием которого было поцеловать Мэгги при всем отряде."
    ...
    al "Это не Толик. На такие фокусы по уровню физической подготовки способны в лагере только два человека, Мэгги и Семён."
    ...
    "В свете луны стало видно, что мы стоим на какой-то ровной каменной плите перед большим склепом."
