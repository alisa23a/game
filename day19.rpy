...
# НЕ СПРАШИВАТЬ
    ...
    al "Славя сказала, что он обогнал."
    ...
    "Когда мы вернулись в лагерь, стало темнеть. Потом был праздничный ужин. Давали котлеты по-киевски с пюрешкой, салат с сыром и оливками и по одному пирожному «корзинка». Ну и лимонад."
