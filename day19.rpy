...
#    $ renpy.music.set_pause(False, delay=1.5, channel="music")
    ...
    al "Уверенна. Будем сидеть, пока ОНО не уйдет. Мне кажется, это то, за чем мы гнались в прошлый раз, но не поймали."
    ...
    "В свете луны стало видно, что мы стоим перед большим склепом, на какой-то ровной плите, на которой были нарисованы чем-то белым как будто круг и звезда. В середине звезды лежал какой-то предмет."
