...
# НЕ СПРАШИВАТЬ
    ...
    al "Факт, не для Слави. Это надо срочно выяснить. Я думаю, тут замешан Семен. И потом, Семен, оказывается, ходит ночью к Жене. Тебе это ни о чем не говорит? Кого он у нас ещё не окучивал?"
    ...
    "И рассказывать там о лагерных новостях, тех, что интересны именно детям? Семен не отказывается иллюстрировать. Ну, что скажете?"
