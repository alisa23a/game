...
label day21_cont4:
    ...
    al "Так я и думала. Семен — извращенец. Вот, гад. Но кто сделал этот тоннель? Это же всё очень давно построено. А домики? Они были с какого года тут возведены?"
    ...
    ul "Об этом-то я не подумала. И смотри, Семен... Она, похоже, не смущена. Черт. Обнимает её в полотенце. Там же... Она же... Под ним же..."
    ...
    gan "Не надо ножом! Пожалуйста... Это... Это Тарас Юрьевич! Только если он узнает, что я проговорился, мне не кранты."
