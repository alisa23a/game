label day24:
    ...
    "Трусики действительно были, и они были под цвет ее платья."
    ...
    "Мы вошли за ней в домик. Домик состоял из пристройки и нескольких комнат. Сначала мы вошли в пристройку. В ней с потолка и отовсюду, откуда только было можно, свисали пучки трав."
    ...
    "Вход в спальню был завешен свисающей шуршащей бамбуковой шторкой."
    ...
    queue music "audio/music/amazing_world.mp3"


    "Мудрый Будда нам оставил два подарка
    \nСказав, реальность ни к чему не приведёт
    \nЯ не поверила, но Бабушка Знахарка
    \nДала грибочек, вот, поешь и всё пройдет"

    "Пройдут твои пустые ожиданья
    \nИсчезнут шрамы раненой души
    \nРеальность, лишь игра сознанья
    \nГрибочек съешь, и радостно дыши"

    "Её послушав, я носилась по лужайке
    \nСо мной о чем-то говорили лес, цветы
    \nКабанчики, олени, мыши, зайки,
    \nСмешные черепахи и коты"

    "Ходила по воде, как тот Спаситель
    \nИ пела песню, Вот, не вспомню слов
    \nИ чуть совсем я не ушла в Обитель
    \nВолшебных, Удивительных Грибов"
