label day28:
    ...
    "Дверь в кладовку склада,  слетела с петель и я увидела как Петрович с ломиком и Семён, ворвались внутрь"
    ...
    "А вечером было собрание персонала. Я забежала в помещение музкружка чтобы успеть всех сфотографировать новым фотоаппаратом для стенгазеты."
