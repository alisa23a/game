label day29:
    ...
    "Когда мы вошли, у неё на столе лежала книга «Унесенные ветром». И Алиса прошептала: «Так вот что она все время читает на пляже. А нам Женя эту книгу не дала»."
    ...
    od "Ну вот и ладненько. Уговорите его вернуться. Остальное я беру на себя. Это надо сделать до приезда его родителей. Они приедут в субботу."
    ...
    od "Она тут давно живет. Некоторые думают, что она из посёлка. Возможно, сирота. Освоилась и живет. Где-то в районе озера. Петрович видел несколько раз, как она ловит рыбу. Очень ловкая. Прямо Маугли."
    ...
    uv "Это было как раз перед очередным дождём. Вода потопа уходит в штольни и поэтому вокруг всегда сухо."
    ...
    "Я залезла в шалаш, думая про тот дождь, который мы тут вместе пережидали."

    "Шалаш был раньше из соломы, но я заметила, что Пионер укрепил его ветками. Наверное, в ту памятную ночь на болотах, здесь тоже было ветрено."


    scene an_002_008 with dissolve

    "Я стала вспоминать нашу с ним рыбалку. И не заметила, как уснула."


    scene cg owl_pine_blink with dissolve

    "И мне снился сон, что я разговариваю с Совой и она дает ответы на все мои вопросы."
