label day30:
    ...
    "Я проснулась. В шалаше никого. И снова приятный запах рыбки от костра. Я выползла на четвереньках из шалаша и поползла к костру. Глаза ещё слипались."

    "Костер едва горел, но угли ярко рдели и булькала в котелке уха. Силуэт пионера с удочкой был виден сквозь туман."
    ...
    "Пионер подошёл, положил удочки и уселся рядом."
    ...
    "Я принялась уписывать уху за обе щеки."

    ul "Вкусно! Я проголодалась. Не смотри."
    ...
    "Я поковыряла палочкой в углях."

    ul "Юля... Э-э-э, она говорит, что ты не пускаешь её в лагерь."
    ...
    "Пионер посмотрел на небо и улыбнулся."

    pi "Я разрешу. Всё равно, скоро дожди. Они все обнулят."
    ...
    "Пионер наклонился ко мне и прошептал:"
    ...
    ul "Тогда я пошла? Я тут очень долго, меня хватятся. Уже линейка прошла. Скоро построение для праздника. Будут искать. Спасибо за форель."
    ...
    "Пионер понизил голос."

    pi "А Генда, это бывший начальник лагеря 410 Бурлейка. На самом деле его фамилия Гендаков."
    ...
    pi "Она его правая рука. Но она сама по себе. Она слишком много о нём знает. И он зависит от её знаний. Она тоже это знает. Ведет какую-то свою игру..."
    ...
    pi "Да, я завишу. Я жив только потому, что мой отец когда-то был его другом."

    pi "А ещё он привык считать меня маленьким мальчиком, которого он когда-то сажал себе на колени."
    ...
    pi "Он носит его с собой. Всегда. Но вместе мы сможем получить этот ключ или найти способ, как-то ещё остановить её. Пока не знаю как. Не придумал."
    ...
    pi "Это хорошо. Потому что там есть бункер, в котором, возможно, находятся те, кто исчезли при взрыве. И скорее всего, поэтому он заминирован."
    ...
    pi "Понимаешь, почему я так думаю, в разговоре с Виолой Гендаков упоминал о каких-то развоплощённых душах, которые он собирается использовать в своем жутком проекте."
    ...
    "Я дотронулась до обтягивающей тело Пионера мокрой рубашки."
    ...
    "Я закрыла глаза и подставила щёку."
    ...
    "Пионер неожиданно поцеловал меня в губы."
    ...
    ul "Черт... Хитрец какой. Я не ожидала. Предупреждать надо."
    ...
    ul "Ну... Э-э-э, нет. Но в любом случае надо было спросить."
    ...
    pi "Не обижайся, но о таком не спрашивают. У тебя мягкие губы... И пахнут клубникой."
    ...
    "С сердитым видом я оттолкнула руку Пионера."

    ul "Не надо, я сама умею грести. Меня Петрович научил. И потом, ты простынешь, на тебе нитки сухой нет."


    scene cg bot_water_ul with dissolve

    "Я уселась в лодке и спустила вёсла в воду."

    ul "Вот только еще, последний вопрос. Что это за люк в полу бомбоубежища, и куда он ведет?"
    ...
    pi "Боже... Так вы были там? Никому не говори. Если ОН узнает, что вы ходите туда, то будет плохо. Забудьте."
    ...
    "Фигура Пионера на берегу стала удаляться. Я сложила ладони рупором и крикнула:  «А твои пахнут мятой!» Но наверное он не расслышал."

    "Пионер стоял на берегу и смотрел мне в след, пока изгиб реки не скрыл его от меня."
    ...
    al "Тут какие-то вещи женские, новые. Смотри, все еще не распечатано. Тут колготки и трикотажные юбочки. Ой, какие красивые... Импортные. Подожди, дай я примерю."
    ...
    al "(Деловито перебирая вещи) \nТак, это размер на Славю. О, а это точно на меня. Вот, тебе эти колготки подойдут, самый маленький размер. Наверное, брал для чьих-то чад. Ну уж точно не для пионерок."
    ...
    ul "Спасибо, хоть не детские мне."
    ...
    al "Да, теперь у меня полный комплект. Но это для танцев. А для конкурса — вот это."

    "Алиса показала мне колготки."

    "Это не какие-то там чулочки, это чешские колготки! На день рождения Женьки устроим в них показ. В общем, относим всё к нам, и я зову девочек."
    ...
    "Зато конкурс колготок прошел на УРА. Девочки вышли в обновах и трикотаже, который выгодно обтягивал стройные фигуры. В колготках все смотрелись старше своего возраста и выглядели как настоящие леди."


    scene cg contest_ul2 with dissolve

    "Я тоже приняла участие. К колготкам я надела розовое платье."

    "Но его пришлось снять. Семен сказал, что будет еще конкурс на лучшее платье. Поэтому мы выйдем в одних рубашках. Одинаковые. Что бы все по-честному. Колготки и рубашка."

    "Тогда никто не получит преимущества и не будет ярким пятном. Так он сказал. Ну что же... Правила есть правила. И я сняла." 
    ...
    "Третье место... Внимание! Судейские записки разделились поровну. Поэтому третье место достается одновременно Мику Хацунэ и Елене Тихоновой!"
    ...
    "Затем огласили два оставшихся места и, по правилам конкурса, назвали сначала того, кто занял второе."

    "Оно досталось Славе. Хотя, все были уверены, что ей достанется только первое место. Она же красавица."
    ...
    scene cg contest_all with dissolve

    "И тогда Семен попросил всех девочек, пока они еще не переоделись в платья, выйти на сцену на «поклон». Ну и для того, чтобы сделать общее фото."

    "Все страшно аплодировали, а мы смущались. Хотя, конечно, всем нам было приятно, что нас «заметили». Мальчики потом говорили, что это было прекрасное зрелище."

    "Эх, жаль что я его не видела. Я ведь стояла на сцене... Но фото получилось отличное!"
    ...
    "Потом девочки переоделись в платья и устроили смотрины обновок. Это тоже был «конкурс» но неофициальный."

    "Жаль, что от него не осталось фотографий. Ведь на мне было такое красивое платье. И маечка. И всё под цвет. Ну вы поняли, о чем я. Ладно, и так было здорово."
