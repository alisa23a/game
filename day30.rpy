label day30:
    ...
    ul "Да, я уже поняла, что есть машина которая меняет время и всякое другое.  А вот, расскажи еще, про шахты и прииск. И про чердак. И про бомбоубежище. И про вуду. У меня так много вопросов..."
