label day30:
    ...
    al "Ой, мамочки, сейчас умру от смеха... Потому что ОН БЫ НА НЕМ! Прямо вижу, как он сидит ночами, голый, волосатый, и перешивает себе твои вещи."
    ...
    al "Надо узнать у ОД, заказывали ли они ему что-то из вещей. Он часто ездил в райценетр, вполне могли. Если не заказывали, мы отдадим нашим девочкам. Тут очень много..."
    ...
    al "Да теперь у меня теперь полный комплект. В общем, относим все к нам и я зову девочек. На день рождения Женьки устроим показ."
    ...
    "Во всяком случае, маленькая сцена там была. Мальчики натащили туда столов и лавок, а мы устроили уборку. А Семен расписал задник сцены под горный пейзаж."
    ...
    "Танцевали под радиоприемник, Семен показывал карточные фокусы, Алиса сделала танцевальный номер, а я читала свои стихи."
    ...
    "А компота взяли из столовой целую трёхлитровую банку. Славя когда попробовала его, сразу выплюнула, сказала, прокис. Я заметила, что Алиса сразу встрепенулась и посмотрела на Семёна."
    ...
    "Зато конкурс чулочек прошел на УРА. Девочки вышли в обновах и трикотаже, который выгодно обтягивал стройные фигуры. В улочках все смотрелись старше своего возраста и выглядели как настоящие леди."
    ...
    "Семен смотрел с неожиданно проснувшимся интересом. А Толик держался за сердце. И только Электроник, улыбался своей вечной, странной улыбкой."

    "Потом грянули аплодисменты. А Семен, как председатель мужского жури, выкрикнул:"
    ...
    sem "(Взобравшись на стул) \nТИХО! Мы тут с ребятами посовещались. И вот что... Женя именинница, но победила она не по этому. Надеюсь, со мной все согласны?"
    ...
    "Все одновременно повыскакивали с мест и закричали «УЛЬЯНЕ! УЛЬЯНЕ!»"
    ...
    "Но она закрыла лицо руками. Как потом она сама призналась, она была уверена, что выиграет Славя. И так сидела. Все ее тормошили и поздравляли. Но у нее было серьезное лицо, какое-то нерадостное."
    ...
    "Помню только, что Семен поднялся с Женей на чердак. Они там о чем то болтали, а дверь была закрыта, и я так и не смогла подслушать."
