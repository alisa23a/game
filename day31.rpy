label day31:
    ...
    "После Дня Рождения Жени к нам утром пришел Семён и рассказал о том, что Ольга Дмитриевна как-то прознала, что нас не было всю ночь. Шум поднимать не стала, но вызвала Славю."

    "Ну, та ей все как на духу и выложила. И про конкурс, и по купание ночью. В общем, она же правильная пионерка. Ну, вы понимаете."

    "Но в конце Семён сказал, что все уладил."
    ...
    "Потом она позвала Женю, и они о чем-то очень долго беседовали. Как результат, всё замяли. В общем, Женя сказала, когда уходила от ОД, что беспокоиться больше не о чем."
    ...
    "А Семён все пытался через плечо почитать, что там написано. Но получил щелчок по носу. И все спрашивал: «От кого, от кого?»"
    ...
    pi "Отец лишился сразу двух любимых людей. Очень горевал. Потом была революция. Всем стало не до поисков. И история эта стала легендой."
    ...
    "Хоть ничего такого, чего боится Алиса (она вечно: «Смотри, чтобы ничего такого!»), у нас не было."
    ...
    "Когда все высадились в Пиратской Гавани, Ольга Дмитриевна сказала, обращаясь к Петровичу и Тарасу Юрьевичу:"
    ...
    "И мы увидели вышедших на полянку Семёна со Славей. Они непринужденно беседовали."


    scene cg sem_sl_clearing with dissolve

    "Потом Семён предложил Славе сесть и они расположились под деревом. Она села к нему на колени, так запросто."
    ...
    "А Семён сразу перевел разговор на другую тему. Я думаю, что они все-таки там целовались."
    ...
    "Потом Славя и Семён пришли к костру мокрые. И Славя на меня пронзительно смотрела, а я отвернулась, как будто я не в курсе."
    ...
    "Ольга Дмитриевна немного посидела и ушла в палатку, чтобы нам не мешать. Кибернетики и Толик тоже куда-то исчезли. Наверное, ушли на ночную рыбалку."
    ...
    "А когда мы вернулись в палатку, то обнаружили в ней спящего Семёна. Наверное, он перепутал палатки, темнело уже."
    ...
    "Я не хотела делать Алисе больно. Но в то же время я хотела, чтобы она побыстрее забыла о Семёне."
    ...
    ul "Но я не целовалась с Семёном, как Славя."
    ...
    al "Ладно, ладно. Верю. Будем надеяться, что ты единственная, кого Лена не подозревает в связях с Семёном. С Ленки станется."
    ...
    "Какие-то силуэты появились у костра. И мне даже показалось, что это Семён и Славя. Ее белые волосы были довольно заметны."
    ...
    ul "Если луна не появится, мы не увидим с крыши, как этот человек будет уходить. И вообще ничего не увидим. Смотри, уже не видно даже кустов внизу."
    ...
    "Радужка сливалась со зрачком и от этого казалась неестественно огромной. Я не уверена, что она была черной, скорее темно-синей, или даже фиолетовой."
    ...
    al "А насчет того, что ты сказала, я тоже подумала. Мы одну мысль думали. Так это, говоришь, была та самая колдунья? Теперь понятно. Эх, Семён, Семён. Натворил ты дел…"
    ...
    "Мы ещё посидели у костра. Подложили в него дров."

    "Я проголодалась, но мы нашли печеную картошку. Думаю, это Славя с Семёном пекли но забыли. Они последние сидели у костра. Забыли, потому что, наверное, им было не до картошки..."
    ...
    al "(Шёпотом) \nЭто Семён. Когда он перепутал мою палатку со своей, а я его высмеяла, на шум прибежали Ленка со Славей. Они наверняка на него обиделись."
    ...
    ul "Наверняка. Он вообще-то должен был спать в палатке Толика, но туда уже заселился Шурик. Логично, что Семён пошел к ОД."
