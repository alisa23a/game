label day34:
    ...
    fi "Я готов в сам убить эту тварь. У меня есть ружьё."
    ...
    pe "Не смеши, что ему твоё ружьё. Ты его еще найди, этого сома. То, что он стал днём появляться у берега, да еще прямо у лагеря, покинул омут. Вот, что меня беспокоит."
    ...
    "В общем, видать, Дрищу было завидно, что Алиса с Вовой (Главным) нашли общий язык, а они с Амбалом вроде как не при чём."
