label day35:
    ...
    "Прошло почти десять минут. Вся команда сидела в оцепенении, боясь шелохнуться. Слышно было только, как дышит через трубку кит-Толик. Петрович сидел нахохлившись."
    ...
    "Мы собрали плавающие в воде весла, но не стал вставлять уключины, боясь, что их скрип вспугнет сома."
    ...
    pe "Рыжая, давай на корму, на руль, а то мы сейчас точно заплывём не туда. Видишь, нас в камыши несет. К пирсу правь. На лодочную станцию. Там есть за что привязать."
    ...
    "Огромные усы волочились как змеи и создавали жуткое зрелище. Было похоже на гигантского кальмара."
    ...
    ul "Я, Ольга Дмитриевна. Это я всех подговорила, а Архип Петрович нас спасал. И вообще, прибежал потом. Он ни при чём."
