label day37:
    ...
    "В ожидании второй подачки, он бодро Семёнил за нами на пристань."
    ...
    "Мы привязали к понтону лодку. Нужно было завести один конец на берег, когда мы прибудем на место. Иначе понтон начнет сносить в сторону водоворота. Также лодка нужна была на случай, если что-то пойдет не по плану."
    ...
    "Алиса снова надела маску и окунула голову в воду, продолжая светить. Потом подняла голову, и сняв маску, закрыла нижний люк и затянула винт."
    ...
    "Мы кинулись к мешочкам с песком, лежащим на полу батискафа, и покидали их в открытый люк. Но ничего не произошло, веса грузиков было явно недостаточно для всплытия."
    ...
    scene cg at_ul_resque with dissolve

    "Затем, проскользнув в него, мы начали стремительно всплывать. При этом Атсуи так сильно сжала мою кисть, что мне показалось, что моя рука сейчас оторвётся."
