label day42:
    ...
    scene cg al_ul_bathiscaphe with dissolve
    ...
    al "НО если принять во внимание течение, то это значит, что подъем будет происходить не вертикально, а под наклоном. А это уже не 30 метров а все 45-50."

    al "Значит, если учесть возню покидания батискафа, мы будем без воздуха полторы минуты, а то и больше. Человеческий максимум — две минуты. Это на пределе."
    ...
    "Алиса выбралась из люка. Сняла маску и сев, стянула с себя мокрую майку. Затем протянула мне руку."
    ...
    "Потерев его мокрой майкой Алисы, мы увидели на нем тускло блеснувшие буквы: «П. ОВЧИННИКОВЪ 1884 год»"
