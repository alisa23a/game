label day45:
    ...
    "Нас с Семеном швырнуло на нос баркаса, где мы на секунду зацепились за свисающий якорь. Но когда баркас встал дыбом, мы улетели в воду."
    ...
    "Семен крепко держал меня за талию. Он греб свободной рукой и вытащил меня на левый берег, который был к нам ближе."
    ...
    "Семен показал на что-то, плывущее мимо нас. Это был Женин рюкзак. За ним плыла Алисина гитара."

    "Семен бросился в воду, и борясь с течением, поймал сначала рюкзак, а потом ему удалось зацепить и гитару, которая чуть было не проплыла мимо него."
    ...
    "Было ещё светло и мы успели высохнуть и даже высушить рюкзак и гитару. Семен придирчиво осмотрел гитару и не найдя трещин, удовлетворенно заметил:"
