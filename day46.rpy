label day46:
    ...
    "И наверное успел бы, если бы не споткнулся. Упавшего Долговязого накрыла черная тень..."
    ...
    al "Не факт, что его потом не станут искать вызванные в лагерь МП охотники, что бы убить собаку-людоеда."
    ...
    "Мы прошли по насыпи несколько километров. Хотелось пить и есть."
    ...
    al "У нас есть блиндаж. Придется переночевать там."


    scene cg view2 with dissolve

    "Мы сошли с насыпи и отправились к лесу."
