label day46:
    ...
    "Шагом чеканным вгоняем булыжник в брусчатку \nПусть нас запомнят оскалом разинутых ртов! \nДо синевы в кулаке мы сжимаем свинчатку \nИ на  «Готов?»  Отвечаем - КОНЕЧНО ГОТОВ!"
