label day46:
    ...
    queue music "audio/music/starry_river.mp3"


    "Ты за эхом уйдёшь в синий лес
    \nВ воду в платье войдёшь или без
    \nИ омоет звездною водой ночь в реке
    \nШрам неистовой любви на руке"

    "На заре
    \nНа заре
    \nНа заре"

    "Обессилевшую плоть в море трав
    \nЯ найду и пойму, что неправ
    \nПримирения с тобой нежный след
    \nСохранит песок реки или нет"

    "Это сон 
    \nЭто сон 
    \nЭто сон"

    "Зелень омута глаз глубина
    \nТвои губы пьянее вина 
    \nИ опять любовью крестит  
    \nИ несёт сквозь время вместе"

    "Звёздная река
    \nЗвёздная река
    \nЗвёздная река"

    "Пальцы пишут в воде письмена
    \nВ ней твои и мои имена
    \nРядом радость и беда
    \nСохранит твоя вода"
