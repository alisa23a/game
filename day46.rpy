label day46:
    ...
    mi "Ладно, тогда я пошла. И не забудьте, вы обещали."
    ...
    scene bg bomp_shelter4 with dissolve

    "В конце коридора был небольшой ангар, в котором на полу были рельсы. Догадка Алисы нашла свое подтверждение. На рельсах стояло что-то, накрытое брезентом."


    pause (10000000000000000000000.0)


    "Мы с Алисой стащили этот чехол."
    ...
    "Дрезина, постукивая на стыках, катилась в сторону леса, за которым простиралась ТОПЬ. Ветер шевелил юбочку Алисы и трепал мой галстук."
