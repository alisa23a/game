...
#    $ show_quick_menu = False
    ...
    al "Сосредоточься пожалуйста, у тебя есть минута, подумай о хорошем. Когда вибрация прекратится, ничего нельзя будет уже исправить. Ну же! Быстрей!"
    ...
    "Каждый стал как будто выше, взрослее."
    ...
    queue music "audio/music/redhead_dream.mp3"
    ...
    "Малыш, уймись и не воруй котлеты \nТебе я нравлюсь? Что-то не пойму \nТы не даёшь мне насладиться летом \nДавай-ка всё рассудим по уму"

    "Проказ твоих не счесть, в тебе динамо \nКакое-то работает весь день \nНа реку, в лес и утром на зарядку \nМеня ты вечно тащишь, а мне лень"

    "Ты вырастешь скоро, на слово поверь \nИ с грустью отвечу, любя \nВо взрослую жизнь приоткроется дверь \nИ ты не узнаешь себя"

    "Мне будет тебя, вот такой, не хватать \nТы будешь прекрасна, я знаю \nНе может никто запретить мне мечтать \nИ я безнадёжно мечтаю"

    "Набегавшись за день, в плечо мне уткнёшься, \nИ спишь не раздеваясь. Я и рад \nИ терпеливо жду, когда проснёшься \nДоверие ценнее всех наград"

    "С тобой себя не ощущаю дедом \nИ древним динозавром в чешуе \nА ты как хвостик, вечно ходишь следом \nИ требуешь внимания к себе"

    "Ты вырастешь скоро, на слово поверь \nИ с грустью отвечу, любя \nВо взрослую жизнь приоткроется дверь \nИ ты не узнаешь себя"

    "Мне будет тебя, вот такой не хватать \nТы будешь прекрасна, я знаю \nНе может никто запретить мне мечтать И я \nИ я безнадёжно мечтаю"
    ...
    "Алиса рванулась к Жану."

    "А дальше я писать не могу. Вот прямо до слез. Так это было. Ну, как в фильмах.  Нет... в сказках. И говорите что хотите, а счастье бывает. Вот."
