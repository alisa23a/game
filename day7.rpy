label day7:
    ...
    "Потом я подумала, что если я возьму немного раков нам с Алисой, то Петрович от этого беднее не станет. Приманка там ещё есть. Другие наползут."

    "Я решила взять несколько самых отборных, нам с Алисой, но увлеклась и обчистила одну раколовку полностью. Такого количества должно хватить на весь наш отряд."

    "Только их нести было трудно. Пришлось снять рубашку и сделать такую себе из неё авоську. Хорошо что у меня под ней купальник. Раки оказались кусачие. Хватали меня за пальцы сквозь майку. Но я быстро бежала."
    ...
    "Саманте вообще принесли огромную кучу писем, но все на русском, и Мэгги ей каждый день читает их. А она всем отвечает."

    "Даже кибернетикам пишут записки. Только Толику ни одной."

    "А еще кроме голубиной почты у нас есть почтовый ящик, в него все пишут всякие кляузы и доносы."

    "Толик вынужден их вынимать и разбирать. Если что-то важное, тогда он несет к МП. Думаю, это вообще была идея директрисы."

    "Но Маргарите Павловне некогда читать все эти записки, и она скинула это на Толика. Откуда я знаю? От самого Толика."

    "И вот мне пришла в голову мысль, написать ему и положить своё письмо в этот ящик. Так никто кроме Толика его не прочтёт."

    "Я написала ему и подписалась «Просто девочка». Потому что это неправильно, что ему никто не пишет. Пусть ему тоже будет письмо. (Что написала, вам знать не обязательно)."
