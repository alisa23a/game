label day7:
    ...
    "Ну, там, напишешь: «Здравствуйте, Василий. Вашу записку прочитала. Я не против дружбы, но если Вы серьезный и решили дружить со мной, то Вы должны сегодня после уроков помочь мне донести портфель»."

    "«Можете пригласить меня в воскресенье в парк и потом в кино на детский сеанс. Там есть детское кафе. Можете угостить меня мороженым. С уважением, Ульяна»."

    "Приписка: «Я люблю эскимо. Пломбир не надо»."
