label day9:
    ...
    "Потом пришли ребята. И Семён сыпанул в костёр покошенной травы. А оказалось, что это конопля, которую Петрович скосил по приказу дирекстрисы но не успел убрать."
