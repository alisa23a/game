label day9:
    ...
    al "Фу ты. Вот это да! Не, я туда не пойду. А вдруг там медведь или рысь? Не думаю, что им понравится, что мы вломились к ним в дом."
    ...
    ul "Смотри-ка, колея какая-то. Да, вот, точно, остатки какой-то тележки. Наверное, тут что-то возили из этой пещеры."
