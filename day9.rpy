label day9:
    ...
    al "Ну ты вредина! Какая разница? Ну они тогда правильно распределяться по организму."
    ...
    play music "audio/audio9day/z_024.mp3"
    ...
    "Мы пошли по тропинке, но вскоре та упирается в скалу и закончилась."
