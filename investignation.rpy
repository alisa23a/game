...
screen read_alice_daiary:
    ...
    button:
        ...
        #focus_mask True
        action Hide ("read_alice_daiary"), Jump("alice_diary")
...
label start_investignation_12:
    ...
    "И я подумала, что смогу прочитать дневник вечером, спокойно устроившись на чердаке. А пока нужно было положить его обратно. Что я и сделала."
