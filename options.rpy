...
define config.name = _("Дневник Ульяны")
...
define build.name = "UlyanasDiary"
...
define config.main_menu_music = "track1.mp3"
...
define config.save_directory = "UlyanasDiary-1702479661"
