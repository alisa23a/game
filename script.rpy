...
screen GameSplashScreen():
    ...
    vbox:
        ...
        vbox:
            ...
            text "Создатели игры не претендуют на авторство многих использованных в игре визуальных материалов, а также всех использованных в игре аудиоматериалов, за исключением специально написанных для неё песен. Также авторскими для разработчиков являются сценарий, часть изображений, анимации, скрипт и редактирование. При создании некоторых изображений были использованы ИИ-инструменты.":
                color "#fff"
                size 30
                #xalign 0.5
